...
/**
 * REST controller for managing {@link com.app.gateway.domain.D}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        return dRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<D> result = dRepository
                    ...
                    .map(existingD -> {
                        if (d.getUid() != null) {
                            existingD.setUid(d.getUid());
                        }
                        if (d.getEntDDDcod() != null) {
                            existingD.setEntDDDcod(d.getEntDDDcod());
                        }
                        if (d.getEntDDDdsc() != null) {
                            existingD.setEntDDDdsc(d.getEntDDDdsc());
                        }
