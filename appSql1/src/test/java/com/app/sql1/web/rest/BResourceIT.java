...
class BResourceIT {
    ...
    void getAllBS() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.[*].entAAAuid").value(hasItem(DEFAULT_ENT_AA_AUID.intValue())))
            .andExpect(jsonPath("$.[*].entBBBcod").value(hasItem(DEFAULT_ENT_BB_BCOD)))
            .andExpect(jsonPath("$.[*].entBBBdsc").value(hasItem(DEFAULT_ENT_BB_BDSC)));
    }
    ...
    void getB() throws Exception {
        ...
        restBMockMvc
            ...
            .andExpect(jsonPath("$.entAAAuid").value(DEFAULT_ENT_AA_AUID.intValue()))
            .andExpect(jsonPath("$.entBBBcod").value(DEFAULT_ENT_BB_BCOD))
            .andExpect(jsonPath("$.entBBBdsc").value(DEFAULT_ENT_BB_BDSC));
    }
